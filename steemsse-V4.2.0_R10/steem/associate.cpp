...
DOMAIN: GUI
FILE: associate.cpp
CONDITION: WIN32 or nothing happens
...
// using strncpy or strcpy_s causes a crash on deassociating
...
bool IsSteemAssociated(EasyStr Exts) {
  ...
  {
    KeyName=Exts; // simply use extension in key path
    // find shell key
...
#endif//WIN32
  return false; // no, our EXE is not associated
}
