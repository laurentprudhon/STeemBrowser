...
#if defined(SSE_WINDOWS_XP_MAX)
DWORD TScreenSaver::screen_saver_activate_time;
#else
ULONGLONG TScreenSaver::screen_saver_activate_time;
#endif
...
#else
            screen_saver_activate_time = GetTickCount64() + screen_saver_timeout_seconds*1000;
#endif
...
void TScreenSaver::updateTimer(){
    ...
    timer_id=SetTimer(NULL,timer_id,(UINT)(screen_saver_activate_time
      -current_time),TScreenSaver::activationTimerProc);
    timer_running = true;
#endif
...
#ifdef WIN32
    WNDCLASS wc={0,WndProc,0,0,hInstance,hGUIIcon[RC_ICO_APP],
...
bool TScreenSaver::initBuffer() {
    ...
    buffer_valid = true;
    draw_char_routine = jump_osd_draw_char;
    return buffer_valid;
#endif//WIN32
...
#endif//#ifndef SSE_NO_SCREENSAVER
//#undef LOGSECTION
