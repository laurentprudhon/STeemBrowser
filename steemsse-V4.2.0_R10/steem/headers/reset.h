...
void power_on(); // called on Steem startup and on snapshot loading
void reset_peripherals(bool Cold); // reset exception and reset instruction
void reset_st(DWORD flags); // reset exception
void agenda_reset(int flags); // reset exception
