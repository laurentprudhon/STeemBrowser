...
enum EDebugEmu {
  ...
  BREAKPOINT_MODE_STOP=2,BREAKPOINT_MODE_LOG=3,
  MAX_BREAKPOINTS=30,
  CYCLE_COL_SPEED=4,
...
void debug_dump_ram(MEM_ADDRESS start,int nbytes); // dump to TRACE.TXT
#endif
...
extern BYTE monitor_mode,breakpoint_mode;
