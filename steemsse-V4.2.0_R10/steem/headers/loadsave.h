...
#if SSE_VERSION>=420
#define SNAPSHOT_VERSION 66
#elif SSE_VERSION>=412
#define SNAPSHOT_VERSION 65
#elif SSE_VERSION>=411
#define SNAPSHOT_VERSION 64
#elif SSE_VERSION>=410
...
extern int LoadSaveAllStuff(BYTE* fp,bool LoadOrSave,int Version=-1,
                            bool ChangeDisksAndCart=true,int *pVerRet=NULL);
#else
extern int LoadSaveAllStuff(FILE *fp,bool LoadOrSave,int Version=-1,
                            bool ChangeDisksAndCart=true,int *pVerRet=NULL);
#endif
