...
extern "C" BYTE ST_Key_Down[MAX_ST_KEYS]; // used by 6301
extern "C" int mousek; 
...
void ikbd_mouse_move(int x,int y,int mouseb,int max_mouse_move=IKBD_DEFAULT_MOUSE_MOVE_MAX);
void IKBD_VBL();
...
void agenda_keyboard_reset(int SoftwareReset);
...
struct THD6301 {
  ...
  // If the file HD6301V1ST.img is available, try to load it
