...
#define RC_ICO_FULLQUIT 47 // also used to cross other icons
...
#define RC_ICO_PRINT 88
#define RC_ICO_CONTROLPANEL 89
#define RC_ICO_SETTINGS 90
#define RC_NUM_ICONS 91
