...
TODO: check which files should be included
TODO: implement in Linux/GCC
---------------------------------------------------------------------------*/
#pragma once
...
#elif defined(SSE_WINDOWS_2000_MIN)
...
// so that winsock.h is not included (we want winsock2)
// in turn we must include some other headers...
...
extern char *ultoa(DWORD,char*,int);
...
//extern char *ultoa(unsigned int,char*,int);
extern char *strupr(char*);
extern char *strlwr(char*);
//extern int random(int);
