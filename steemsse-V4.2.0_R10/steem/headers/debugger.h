...
extern HMENU debugger_menu,breakpoint_menu,monitor_menu,breakpoint_irq_menu;
...
extern HMENU iobrowser_menu,vectorbrowser_menu; // for grouping
...
void disa_to_file(FILE*fp,MEM_ADDRESS dstart,int dlen,bool);
