...
/*  OPCODE pointers
    ...
    This function may seem messy, instruction decoding is messier on the real
    MC68000, see ijor's FX68K project (which we used to check illegal opcodes). */

void cpu_routines_init() {
  for(DWORD op=0;op<=0xffff;op++) // there are $FFFF + 1 entries -> DWORD
  {
    ...
    bool above111001=((op&BITS_543)==BITS_543_111&&op7>1);
    bool above111100=((op&BITS_543)==BITS_543_111&&op7>4);
    bool src_adreg=(b543==BITS_543_001);
    bool above111100or_src_adreg=(above111100||src_adreg);
    ...
    case 0:
      ...
      case B6_000000: 
        if((op&B6_111111)==B6_111100)
          m68k_call_table[op]=m68k_ori_b_to_ccr, skip_test2=true;
        else
          m68k_call_table[op]=m68k_ori_b;
        break;
      case B6_000001:
        if((op&B6_111111)==B6_111100)
          m68k_call_table[op]=m68k_ori_w_to_sr, skip_test2=true;
        else
          m68k_call_table[op]=m68k_ori_w;
        break;        
      case B6_000010:
        m68k_call_table[op]=m68k_ori_l;break;
      case B6_001000:
        if((op&B6_111111)==B6_111100)
          m68k_call_table[op]=m68k_andi_b_to_ccr, skip_test2=true;
        else
          m68k_call_table[op]=m68k_andi_b;
        break;        
      case B6_001001:
        if((op&B6_111111)==B6_111100)
          m68k_call_table[op]=m68k_andi_w_to_sr, skip_test2=true;
        else
          m68k_call_table[op]=m68k_andi_w;
        break;
      ...
      case B6_101000:
        if((op&B6_111111)==B6_111100)
          m68k_call_table[op]=m68k_eori_b_to_ccr, skip_test2=true;
        else
          m68k_call_table[op]=m68k_eori_b;
        break;        
      case B6_101001:
        if((op&B6_111111)==B6_111100)
          m68k_call_table[op]=m68k_eori_w_to_sr, skip_test2=true;
        else
          m68k_call_table[op]=m68k_eori_w;
        break;
      ...
      default:
        ...
        else
        {
          ...
          if((op&BITS_543)==BITS_543_111 && op7>(DWORD)(b3==B6_000100?4:1))
            m68k_call_table[op]=m68k_trap1;
        }
      }//sw
      if(!skip_test2)
      {
        ...
        case BITS_543_111:
          ...
          case 4: // #
            ...
            break;
          default:
            switch(b6) { // read-only can use (pc)
            case B6_100000: // BTST
              break;
            default:
              m68k_call_table[op]=m68k_trap1;
      ...
      break;
    case 1:
      if((op&BITS_876)==BITS_876_001
        ||(op&BITS_876)==BITS_876_111&&(op&BITS_ba9)>BITS_ba9_001
        ||above111100or_src_adreg)
      {} //trap1
      else
    ...
    case 4:
      ...
      case B6_101011: 
        if((op&B6_111111)==B6_111100) // ILLEGAL
          m68k_call_table[op]=m68k_trap1, skip_test2=true;
        else
          m68k_call_table[op]=m68k_tas;
        break;
      case B6_110010:
      case B6_110011:
        skip_test2=true;
    ...
    case 5:
      switch(b876) {
      case 0: if(!above111001&&!src_adreg)
                m68k_call_table[op]=m68k_addq_b;
              break;
      case 1: if(!above111001)
                m68k_call_table[op]=m68k_addq_w;
        break;
      case 2: if(!above111001)
                m68k_call_table[op]=m68k_addq_l;
        break;
      case 3:
      case 7:
        ...
        break;
      case 4: if(!above111001&&!src_adreg)
                m68k_call_table[op]=m68k_subq_b;
        break;
      case 5: if(!above111001)
                m68k_call_table[op]=m68k_subq_w;
        break;
      case 6: if(!above111001)
                m68k_call_table[op]=m68k_subq_l;
        break;
      }
      break;
    case 6:
    ...
    case 8:
      ...
      case 0:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_or_b_to_dN;
        break;
      case 1:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_or_w_to_dN;
        break;
      case 2:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_or_l_to_dN;
        break;
      case 3:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_divu;
        break;
      case 4:
        if(!above111001)
          m68k_call_table[op]=(b543>BITS_543_001)?m68k_or_b_from_dN:m68k_sbcd;
        break;
      case 5:
        if(!above111001 && (b543>BITS_543_001))
          m68k_call_table[op]=m68k_or_w_from_dN;
        break;
      case 6:
        if(!above111001 && (b543>BITS_543_001))
          m68k_call_table[op]=m68k_or_l_from_dN;
        break;
      case 7:
        m68k_call_table[op]=(above111100or_src_adreg)?m68k_trap1:m68k_divs;
        break;
      }
      break;
    case 9:
      switch(b876) {
      case 0: if(!above111100or_src_adreg)
                m68k_call_table[op]=m68k_sub_b_to_dN;
         break;
       case 1: if(!above111100)
                 m68k_call_table[op]=m68k_sub_w_to_dN;
         break;
       case 2: if(!above111100)
                 m68k_call_table[op]=m68k_sub_l_to_dN;
         break;
       case 3: if(!above111100)
                 m68k_call_table[op]=m68k_suba_w;
         break;
       case 4: if(!above111001)
                 m68k_call_table[op]=(b543>BITS_543_001)
                  ? m68k_sub_b_from_dN:m68k_subx_b;
         break;
       case 5: if(!above111001)
                 m68k_call_table[op]=(b543>BITS_543_001)
                  ?m68k_sub_w_from_dN:m68k_subx_w;
         break;
       case 6: if(!above111001)
                 m68k_call_table[op]=(b543>BITS_543_001)
                  ?m68k_sub_l_from_dN:m68k_subx_l;
         break;
       case 7: if(!above111100)
                 m68k_call_table[op]=m68k_suba_l;
         break;
      }
      break;
    case 0xa:
    ...
    case 0xb:
      switch(b876) {
      case 0: if(!above111100or_src_adreg)
                m68k_call_table[op]=m68k_cmp_b;
        break;
      case 1: if(!above111100)
                m68k_call_table[op]=m68k_cmp_w;
        break;
      case 2: if(!above111100)
                m68k_call_table[op]=m68k_cmp_l;
        break;
      case 3: if(!above111100)
                m68k_call_table[op]=m68k_cmpa_w;
        break;
      case 4: if(!above111001)
                m68k_call_table[op]=(b543==BITS_543_001)
                ? m68k_cmpm_b : m68k_eor_b;
        break;
      case 5: if(!above111001)
                m68k_call_table[op]=(b543==BITS_543_001)
                ? m68k_cmpm_w : m68k_eor_w;
        break;
      case 6: if(!above111001)
                m68k_call_table[op]=(b543==BITS_543_001)
                ? m68k_cmpm_l : m68k_eor_l;
        break;
      case 7: if(!above111100)
                m68k_call_table[op]=m68k_cmpa_l;
        break;
      }
      break;
    case 0xc:
      ...
      case 0:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_and_b_to_dN;
        break;
      case 1:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_and_w_to_dN;
        break;
      case 2:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_and_l_to_dN;
        break;
      case 3:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_mulu;
        break;
      case 4:
        if(!above111001)
          m68k_call_table[op]=(b543>BITS_543_001)
            ?m68k_and_b_from_dN:m68k_abcd;
        break;
      case 5:
        if(!above111001)
          m68k_call_table[op]=(b543>BITS_543_001)
            ? m68k_and_w_from_dN : m68k_exg_like;
        break;
      case 6:
        if(!above111001 && b543!=BITS_543_000)
          m68k_call_table[op]=(b543==BITS_543_001)
            ? m68k_exg_unlike : m68k_and_l_from_dN;
        break;
      case 7:
        if(!above111100or_src_adreg)
          m68k_call_table[op]=m68k_muls;
        break;
      }
      break;
    case 0xd:
      switch(b876) {
      case 0: if(!above111100or_src_adreg)
                m68k_call_table[op]=m68k_add_b_to_dN;
        break;
      case 1: if(!above111100)
                m68k_call_table[op]=m68k_add_w_to_dN;
        break;
      case 2: if(!above111100)
                m68k_call_table[op]=m68k_add_l_to_dN;
        break;
      case 3: if(!above111100)
                m68k_call_table[op]=m68k_adda_w;
        break;
      case 4: if(!above111001)
                m68k_call_table[op]=(b543>BITS_543_001)
                  ? m68k_add_b_from_dN : m68k_addx_b;
        break;
      case 5: if(!above111001)
                m68k_call_table[op]=(b543>BITS_543_001)
                  ? m68k_add_w_from_dN : m68k_addx_w;
        break;
      case 6: if(!above111001)
                m68k_call_table[op]=(b543>BITS_543_001)
                  ? m68k_add_l_from_dN : m68k_addx_l;
        break;
      case 7: if(!above111100)
                m68k_call_table[op]=m68k_adda_l;
        break;
      }
      break;
    case 0xe: 
    {
      BOOL bToMem=((b876&3)==3);
      switch(b876543) {
      ...
      default:
        if(bToMem && b543>=BITS_543_010 && !above111001)
        {
          switch(op&BITS_ba9) {
          case BITS_ba9_000:
          case BITS_ba9_001:
      ...
      //to same function
      if(!bToMem && b543>=BITS_543_100 && m68k_call_table[op]==m68k_trap1)
  ...
  // illegal already taken care of, could refactor this, but we see no
  // performance impact, and it's self-documenting
