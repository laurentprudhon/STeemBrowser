...
BCB_BUILD - Compile in Borland C++ Builder
BCC_BUILD - Compile with Borland C++ command line
MINGW_BUILD - Compile with MinGW
VC_BUILD - Compile with Microsoft Visual C++
...
DEBUG_BUILD/NO_DEBUG_BUILD - Control debug build on/off (Win only)
NO_486_ASM - Disable all use of assembler routines (must add draw_c.cpp)
NO_RARLIB - Turn off that loverly RAR code
...
// Except in the old BCBuilder, the macros USE... will do NOTHING at all!
// It's fair to say this file does nothing useful
