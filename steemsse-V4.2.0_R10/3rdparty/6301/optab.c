...
//  {0x61, 1, aim_ind_x,  7,  "aim %02x,x"},  /* 6301 */ //SSE
  {0x61, 2, aim_ind_x,  7,  "aim (#,addr) %04x,x"}, /* 6301 */ //SSE
//  {0x62, 1, oim_ind_x,  7,  "oim %02x,x"},  /* 6301 */ //SSE
  {0x62, 2, oim_ind_x,  7,  "oim %04x,x"},  /* 6301 */ //SSE
  {0x63, 1, com_ind_x,  6,  "com %02x,x"},
  {0x64, 1, lsr_ind_x,  6,  "lsr %02x,x"},
//  {0x65, 1, eim_ind_x,  7,  "eim %02x,x"},  /* 6301 */ //SSE
  {0x65, 2, eim_ind_x,  7,  "eim %04x,x"},  /* 6301 */ //SSE
...
//  {0x6b, 1, tim_ind_x,  5,  "tim %02x,x"},  /* 6301 */ //SSE
  {0x6b, 2, tim_ind_x,  5,  "tim %04x,x"},  /* 6301 */ //SSE
...
//  {0x71, 0, aim_dir,  6,  "aim %02x"},  /* 6301 */ // SSE
  {0x71, 2, aim_dir,  6,  "aim %04x"},  /* 6301 */ // SSE
//  {0x72, 0, oim_dir,  6,  "oim %02x"},  /* 6301 */ //SSE
  {0x72, 2, oim_dir,  6,  "oim %02x"},  /* 6301 */ //SSE
  {0x73, 2, com_ext,  6,  "com %04x"},
  {0x74, 2, lsr_ext,  6,  "lsr %04x"},
//  {0x75, 0, eim_dir,  6,  "eim %02x"},  /* 6301 */ // SSE
  {0x75, 2, eim_dir,  6,  "eim %04x"},  /* 6301 */ // SSE
  {0x76, 2, ror_ext,  6,  "ror %04x"},
  {0x77, 2, asr_ext,  6,  "asr %04x"},
  {0x78, 2, lsl_ext,  6,  "lsl %04x"},
  {0x79, 2, rol_ext,  6,  "rol %04x"},
  {0x7a, 2, dec_ext,  6,  "dec %04x"},
//  {0x7b, 0, tim_dir,  4,  "tim %02x"}, //SSE
  {0x7b, 2, tim_dir,  4,  "tim %04x"}, //SSE
