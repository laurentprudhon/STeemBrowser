...
Preprocessors          :=$(PreprocessorSwitch)NDEBUG $(PreprocessorSwitch)UNIX $(PreprocessorSwitch)LINUX $(PreprocessorSwitch)SSE_RELEASE $(PreprocessorSwitch)SSE_LINUX_DYN 
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)X11 $(LibrarySwitch)Xext $(LibrarySwitch)pthread $(LibrarySwitch)Xxf86vm $(LibrarySwitch)asound $(LibrarySwitch)portaudio $(LibrarySwitch)capsimage $(LibrarySwitch)pulse $(LibrarySwitch)rtaudio 
ArLibs                 :=  "X11" "Xext" "pthread" "Xxf86vm" "libasound" "portaudio" "capsimage" "pulse" "rtaudio" 
...
CXX      := /usr/bin/g++
CC       := /usr/bin/gcc
CXXFLAGS :=  -O -O2 -W -std=c++11 -Wall -Wno-unknown-pragmas -Wno-write-strings -Wno-unused-result -Wno-pointer-arith $(Preprocessors)
CFLAGS   :=  -O2 -Wall -Wno-implicit-int -Wno-return-type $(Preprocessors)
ASFLAGS  := 
AS       := /usr/bin/nasm
...
PostBuild:
	...
	cp ./ReleaseDyn/xsteem ./output/xsteem32
	@echo Done

MakeIntermediateDirs:
	@test -d ./ReleaseDyn || $(MakeDirCommand) ./ReleaseDyn
...
$(IntermediateDirectory)/steem_dma.cpp$(ObjectSuffix): ../steem/dma.cpp $(IntermediateDirectory)/steem_dma.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/user/Documents/ST/steem/dma.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/steem_dma.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/steem_dma.cpp$(DependSuffix): ../steem/dma.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/steem_dma.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/steem_dma.cpp$(DependSuffix) -MM "../steem/dma.cpp"

$(IntermediateDirectory)/steem_dma.cpp$(PreprocessSuffix): ../steem/dma.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/steem_dma.cpp$(PreprocessSuffix) "../steem/dma.cpp"
...
$(IntermediateDirectory)/steem_acsi.cpp$(ObjectSuffix): ../steem/acsi.cpp $(IntermediateDirectory)/steem_acsi.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/user/Documents/ST/steem/acsi.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/steem_acsi.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/steem_acsi.cpp$(DependSuffix): ../steem/acsi.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/steem_acsi.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/steem_acsi.cpp$(DependSuffix) -MM "../steem/acsi.cpp"

$(IntermediateDirectory)/steem_acsi.cpp$(PreprocessSuffix): ../steem/acsi.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/steem_acsi.cpp$(PreprocessSuffix) "../steem/acsi.cpp"
...
$(IntermediateDirectory)/steem_printer.cpp$(ObjectSuffix): ../steem/printer.cpp $(IntermediateDirectory)/steem_printer.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/user/Documents/ST/steem/printer.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/steem_printer.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/steem_printer.cpp$(DependSuffix): ../steem/printer.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/steem_printer.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/steem_printer.cpp$(DependSuffix) -MM "../steem/printer.cpp"

$(IntermediateDirectory)/steem_printer.cpp$(PreprocessSuffix): ../steem/printer.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/steem_printer.cpp$(PreprocessSuffix) "../steem/printer.cpp"

$(IntermediateDirectory)/steem_interface_pulse.cpp$(ObjectSuffix): ../steem/interface_pulse.cpp $(IntermediateDirectory)/steem_interface_pulse.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/user/Documents/ST/steem/interface_pulse.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/steem_interface_pulse.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/steem_interface_pulse.cpp$(DependSuffix): ../steem/interface_pulse.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/steem_interface_pulse.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/steem_interface_pulse.cpp$(DependSuffix) -MM "../steem/interface_pulse.cpp"

$(IntermediateDirectory)/steem_interface_pulse.cpp$(PreprocessSuffix): ../steem/interface_pulse.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/steem_interface_pulse.cpp$(PreprocessSuffix) "../steem/interface_pulse.cpp"
