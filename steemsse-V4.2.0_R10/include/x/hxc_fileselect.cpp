                            ...
                            int pass_mode,LPHXC_FILESELECTPARSE pr,char*defext)
{
  ...
  hxc::SetProp(XD,Win,cWinProc,(DWORD_PTR)WinProc);
  hxc::SetProp(XD,Win,cWinThis,(DWORD_PTR)this);
...
int hxc_fileselect::edit_notifyproc(hxc_edit* ed,int mess,INT_PTR i){
...
int hxc_fileselect::listview_notify_handler(hxc_listview* lv,int mess,INT_PTR i)
{
