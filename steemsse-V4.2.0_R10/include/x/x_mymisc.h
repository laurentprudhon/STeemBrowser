...
//---------------------------------------------------------------------------
extern bool SetProp(Display *Disp,Window Win,XContext Prop,DWORD_PTR Val);
extern DWORD_PTR GetProp(Display *Disp,Window Win,XContext Prop);
extern DWORD_PTR RemoveProp(Display *Disp,Window Win,XContext Prop);
