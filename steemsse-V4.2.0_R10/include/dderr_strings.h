#pragma once
#ifndef DDERR_STRINGS_H
#define DDERR_STRINGS_H
...
"Windows can not create any more device contexts (DCs), or a DC was requested\
for a palette-indexed surface when the surface had no palette and the display mode\
was not palette-indexed (in this case DirectDraw cannot select a proper palette\
into the DC)."
