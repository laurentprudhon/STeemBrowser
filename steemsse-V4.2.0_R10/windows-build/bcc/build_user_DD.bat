...
echo -----------------------------------------------
"%BCCPATH%make.exe" -fmakefil3q.txt -DDONT_ALLOW_DEBUG -DSTEVEN_SEAGAL -DSSE_DD 3rdparty
echo ------------------------------------------
echo Building Steem SSE using Borland C/C++ 5.5
echo ------------------------------------------
"%BCCPATH%make.exe" -fmakefil3q.txt -DDONT_ALLOW_DEBUG -DBCC_BUILD -DSTEVEN_SEAGAL -DSSE_DD
