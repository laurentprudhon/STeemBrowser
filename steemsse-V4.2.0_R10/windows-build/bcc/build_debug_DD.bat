...
echo -----------------------------------------------
"%BCCPATH%make.exe" -fmakefil3q.txt -DFORCE_DEBUG_BUILD -DSTEVEN_SEAGAL -DSSE_DD 3rdparty
rem pause
echo -----------------------------------------------------
echo Building Steem SSE (Debugger) using Borland C/C++ 5.5
echo -----------------------------------------------------
"%BCCPATH%make.exe" -fmakefil3q.txt -DFORCE_DEBUG_BUILD -DBCC_BUILD -DSTEVEN_SEAGAL -DSSE_DD
