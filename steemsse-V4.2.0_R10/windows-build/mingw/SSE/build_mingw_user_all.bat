...
echo -----------------------------------------------
mingw32-make.exe -fmakefile_MinGW.txt USER=1 3rdparty MAKEFILE_PATH=makefile_MinGW.txt >3rdparty.log

echo -----------------------------------------------
echo Building Steem SSE using MinGW
echo -----------------------------------------------
rem STEVEN_SEAGAL is defined in the makefile
mingw32-make.exe -fmakefile_MinGW.txt USER=1 MAKEFILE_PATH=makefile_MinGW.txt >steem.log
